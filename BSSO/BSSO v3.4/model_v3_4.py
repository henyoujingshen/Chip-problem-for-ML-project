...
from BSSO_v3_4 import enabled_model
...
def baseModel(Sample_X, Sample_Warp, parameters, num_boost_round, index):
...
def modelTrain(Sample_X, Sample_Warp, parameters, num_boost_round, generation):
    """
    k-fold要求初始采样点是几十一个
    ...
    if index == 4:
        a = generation
        base_model, base_round, valid_pred, y_valid, valid_error = baseModel(Sample_X, Sample_Warp, parameters, num_boost_round, index)
